    ...
    <div class="container">
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 2rem;">
            <div class="recommendations-section">
                ...
                <ul class="recommendation-list">
                    <li>
                        ...
                        <div>
                            <strong>Start with Organizations:</strong> If you have multiple clubs or schools competing, create organizations first to keep everything organized.
                        </div>
                    </li>
                    <li>
                        <div class="recommendation-icon">2</div>
                        <div>
                            <strong>Batch Create Teams:</strong> Create all your teams before adding athletes. This makes athlete registration much faster.
                        </div>
                    </li>
                    <li>
                        <div class="recommendation-icon">3</div>
                        <div>
                            <strong>Register Judges Early:</strong> Set up judge accounts early so they can familiarize themselves with the scoring system.
                        </div>
                    </li>
                    <li>
                        <div class="recommendation-icon">4</div>
                        <div>
                            <strong>Test Events:</strong> Create a test event first to make sure everything works before your main competition.
                        </div>
                    </li>
                    <li>
                        <div class="recommendation-icon">5</div>
                        <div>
                            <strong>Assign Judges in Advance:</strong> Complete judge assignments before the competition day to avoid delays.
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="activity-section">
                ...
                <?php else: ?>
                <p style="color: #64748B; text-align: center; padding: 2rem;">No activity yet. Start creating your competition setup!</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
